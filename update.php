         ...
         <center> <h1 style="color:red;opacity:1;"> Available Doctors </h1></center>
          <?php
           ...
           while($row1=$result->fetch_array())
            {
              $a=1;
              echo "<tr><td>$row1[2] $row1[3] $row1[4]</td><td> $row1[5]</td><td> $row1[6]</td><td>$row1[7] $row1[8] $row1[9]</td><td>$row1[10]</td><td><form action='update_fo.php' method='post' ><input type='text' value='$row1[0]' style='display:none' name='id'><input type='submit'value='Update Doctor'></a></form></td></tr>";
            }
            echo "</table></center>";
            if($a==0)
             {
